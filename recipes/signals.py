#  Copyright (c) Code Written and Tested by Ahmed Emad in 24/03/2020, 14:45.
import re
...
from recipes.models import RecipeModel, RecipeReviewModel
...
@receiver(pre_save, sender=RecipeReviewModel)
